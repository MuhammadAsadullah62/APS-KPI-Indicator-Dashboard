...
class AvatarUploadTest extends TestCase
{
    ...
    {
        Storage::fake('public');
        $user = User::factory()->role(UserRole::Faculty)->create(['wing' => Wing::Senior]);
    ...
    {
        Storage::fake('public');
        $admin = User::factory()->role(UserRole::Principal)->create(['wing' => null]);
        $sh = User::factory()->role(UserRole::SectionHead)->create(['wing' => Wing::Senior, 'name' => 'Jane Roe']);
